...
# Setup the handler
logger = setup_logger(logging.DEBUG, "WebsiteInputRestHandler", "website_input_rest_handler.log")

class WebsiteInputRestHandler(admin.MConfigHandler):
    """
    The REST handler provides configuration management for web ping.
    """
    
    # Below is the name of the conf file
    CONF_FILE = 'app_website_input'
